...
namespace Opw.PineBlog.Sample.EntityFrameworkCore.Controllers
{
    public class FileControllerTests : IClassFixture<TestWebApplicationFactory>
    {
        ...
        {
            var file = "Opw.PineBlog.Sample.EntityFrameworkCore.Resources.large-image.jpg";
            await _client.EnsureAuthenticationCookieAsync(_authenticationContext);
            ...
            using (var formData = new MultipartFormDataContent())
            {
                ...
                result.Should().Be("File: \"Opw.PineBlog.Sample.EntityFrameworkCore.Resources.large-image.jpg\" exceeds 1 MB.");
            }
        }
    }
}
